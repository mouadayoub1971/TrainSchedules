...
import com.mouad.frontend.Services.KafkaLogConsumerService;
...
public class StatisticsController {
    ...
    private void showBookingDetails() {
        try {
            ...
            e.printStackTrace();
            CustomAlert.showError("Error", "Could not show booking details: " + e.getMessage());
        }
    }
    ...
    private void showStatisticsDetails() {
        try {
            ...
            e.printStackTrace();
            CustomAlert.showError("Error", "Failed to load statistics details window");
        }
    }
